...
class A_GE_CAR_PERSONA(db.Model):
    ...
    sexe = db.Column(db.Numeric(1,0))
    ss = db.Column(db.String(20))
    tipus = db.Column(db.Numeric(2,0))
    data_neix = db.Column(db.Date)
    lloc_neix = db.Column(db.String(30))
    provincia_neix = db.Column(db.Numeric(4,0))
    comarca_neix = db.Column(db.Numeric(38,0))
    auto_neix = db.Column(db.Numeric(38,0))
    pais_neix = db.Column(db.Numeric(4,0))
    direccio = db.Column(db.String(40))
    poblacio = db.Column(db.String(30))
    provincia = db.Column(db.Numeric(4,0))
    cp = db.Column(db.String(15))
    comarca = db.Column(db.Numeric(38,0))
    autonomia = db.Column(db.Numeric(38,0))
    pais = db.Column(db.Numeric(4,0))
    ...
    nivel_academic = db.Column(db.Numeric(4,0))
    tipus_centre = db.Column(db.Numeric(8,0))
    nom_centre = db.Column(db.String(50))
    aceptacio = db.Column(db.Numeric(1,0))
    revisiom = db.Column(db.Numeric(1,0))
    revisiops = db.Column(db.Numeric(1,0))
    fitxacomplerta = db.Column(db.Numeric(1,0))
    ...
    actiu = db.Column(db.Numeric(1,0))
    identificador_ant = db.Column(db.String(15))
    id_med = db.Column(db.Numeric(38,0))
    id_fis = db.Column(db.Numeric(38,0))
    id_psi = db.Column(db.Numeric(38,0))
    cip = db.Column(db.String(25))
    consentiment = db.Column(db.Numeric(1,0))
    data_consentiment = db.Column(db.Date)
    data_revisiom = db.Column(db.Date)
    consentiment_dad = db.Column(db.Numeric(1,0))
    consentiment_proinf = db.Column(db.Numeric(1,0))
    pro_sal_es = db.Column(db.Numeric(1,0))
