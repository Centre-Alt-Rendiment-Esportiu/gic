...
class UsersSchema(Schema):
    ...
    foto = fields.String()
    dni = fields.String()
    passaport = fields.String()
    nom = fields.String(validate=not_blank)
    cognom1 = fields.String()
    cognom2 = fields.String()
    sexe = fields.Integer()
    ss = fields.String()
    tipus = fields.Integer()
    data_neix = fields.Date()
    lloc_neix = fields.String()
    provincia_neix = fields.Integer()
    comarca_neix = fields.Integer()
    auto_neix = fields.Integer()
    pais_neix = fields.Integer()
    direccio = fields.String()
    poblacio = fields.String()
    provincia = fields.Integer()
    cp = fields.String()
    comarca = fields.Integer()
    autonomia = fields.Integer()
    pais = fields.Integer()
    telefon1 = fields.String()
    telefon2 = fields.String()
    e_mail = fields.String()
    estudis_act = fields.String()
    nivel_academic = fields.Integer()
    tipus_centre = fields.Integer()
    nom_centre = fields.String()
    aceptacio = fields.Integer()
    revisiom = fields.Integer()
    revisiops = fields.Integer()
    fitxacomplerta = fields.Integer()
    vehicle = fields.String()
    matricula = fields.String()
    tutor1 = fields.String()
    contacto1 = fields.String()
    tutor2 = fields.String()
    contacto2 = fields.String()
    actiu = fields.Integer()
    identificador_ant = fields.String()
    id_med = fields.Integer()
    id_fis = fields.Integer()
    id_psi = fields.Integer()
    cip = fields.String()
    consentiment = fields.Integer()
    data_consentiment = fields.Date()
    data_revisiom = fields.Date()
    consentiment_dad = fields.Integer()
    consentiment_proinf = fields.Integer()
    pro_sal_es = fields.Integer()
    e_mail2 = fields.String()
